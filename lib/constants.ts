...
export const FALLBACK_SERVICES: FallbackService[] = [
  ...
  {
    title: "Site Plans & Mapping",
    slug: "site-plans-mapping",
    shortDescription: "Detailed site plans and property mapping for permit and planning submissions.",
    description:
      "We prepare detailed site plans and maps showing property boundaries, setbacks, grading, and structure placement — the documentation municipalities require to evaluate your project against zoning and planning rules.",
    icon: "Map",
    ...
    features: [
      ...
      "Planning submission ready",
    ],
    process: [
      { step: "01", title: "Site Review", description: "We gather property details and requirements." },
      { step: "02", title: "Mapping", description: "Site plans are drafted to scale with required details." },
      { step: "03", title: "Compliance Check", description: "Plans are checked against zoning setbacks." },
      { step: "04", title: "Delivery", description: "Final site plans are prepared for submission." },
    ],
  },
  {
  ...
  {
    title: "Addition Drawings",
    slug: "addition-drawings",
    shortDescription: "Drawings for home and building additions, prepared for approval.",
    description:
      "Whether it's a second-storey addition or a rear extension, we prepare detailed addition drawings that integrate with your existing structure and meet municipal permit requirements.",
    icon: "LayoutGrid",
    image: "https://images.unsplash.com/photo-1541888946425-d81bb19240f5?auto=format&fit=crop&w=1600&q=80",
    features: ["Structural integration", "Elevation matching", "Code compliance", "Permit submission ready"],
    process: [
  ...
  },
  {
    ...
    description:
      "Secondary units and finished basements have specific permit requirements around egress, ceiling height, and fire separation. We prepare drawings that address these requirements clearly for municipal review.",
    icon: "Layers",
    image: "https://images.unsplash.com/photo-1541976590-713941681591?auto=format&fit=crop&w=1600&q=80",
    features: ["Egress & fire separation detail", "Ceiling height verification", "Secondary suite compliance", "Permit-ready drawings"],
    process: [
  ...
  },
  {
    ...
    shortDescription: "Drawings and documentation for commercial and mixed-use projects.",
    description:
      "Commercial projects come with additional layers of review. We prepare commercial drawings and supporting documentation designed to meet the requirements of municipal and commercial building review processes.",
    icon: "Building",
    image: "https://images.unsplash.com/photo-1523217582562-09d0def993a6?auto=format&fit=crop&w=1600&q=80",
    features: ["Commercial code compliance", "Multi-stage documentation", "Municipal coordination", "Construction-ready plans"],
    process: [
